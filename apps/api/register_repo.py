"""CLI: 把一个下游 AI Coding 本地仓库注册到Pecker反馈闭环。
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description="注册下游 AI Coding 仓库到Pecker信鸽反馈闭环",
    )
    parser.add_argument("repo_path", help="下游 AI Coding 仓库的本地路径(绝对或相对皆可,会自动规范化)")
    parser.add_argument("--workspace", required=True,
                        help="Pecker workspace 名或路径,如 workspace-sample")
    parser.add_argument("--scope", required=True,
                        help="信号过滤关键词,如 sample module")
