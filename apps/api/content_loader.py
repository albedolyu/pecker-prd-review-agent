...
#
# PM 已经在 example_product_wiki_frontmatter_batch 里把 51 个示例产品代码库 wiki 文件标了
...
DEFAULT_EXTERNAL_CANONICAL_WIKI = r"C:/Users/20834/Desktop/代码项目/示例产品代码库/wiki"
...
def load_wiki_pages(wiki_path: str) -> Dict[str, str]:
    ...
    #
    # P1 修法 (2026-04-26): 示例产品 wiki 是子目录结构 (api/ architecture/ concepts/ ...),
